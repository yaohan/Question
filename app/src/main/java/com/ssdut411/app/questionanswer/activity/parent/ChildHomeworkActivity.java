 ...
 */
public class ChildHomeworkActivity extends BaseListViewActivity {
    ...
    private void setList() {
        ...
        getStudentHomeworkReq.setId(MainApplication.getInstance().getChildId());
